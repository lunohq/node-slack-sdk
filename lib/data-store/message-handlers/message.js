...
var addMessageToChannel = function addMessageToChannel(dataStore, message) {
  return dataStore.getChannelGroupOrDMById(message.channel)
    .then(function addMessageToChannelPromiseInner(baseChannel) {
      baseChannel.addMessage(message);
      return dataStore.upsertChannelGroupOrDMById(baseChannel.id, baseChannel);
    });
};
...
var baseChannelJoin = function baseChannelJoin(dataStore, message) {
  return dataStore.getChannelGroupOrDMById(message.channel)
    .then(function baseChannelJoinPromiseInner(baseChannel) {
...
var baseChannelLeave = function baseChannelLeave(dataStore, message) {
  return dataStore.getChannelGroupOrDMById(message.channel)
    .then(function baseChannelLeavePromiseInner(baseChannel) {
...
var baseChannelMessageDeleted = function baseChannelMessageDeleted(dataStore, message) {
  return dataStore.getChannelGroupOrDMById(message.channel)
    .then(function baseChannelMessageDeletedPromiseInner(baseChannel) {
...
var baseChannelMessageChanged = function baseChannelMessageChanged(dataStore, message) {
  return dataStore.getChannelGroupOrDMById(message.channel)
    .then(function baseChannelMessageChangedPromiseInner(baseChannel) {
